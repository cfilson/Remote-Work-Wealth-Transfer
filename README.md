...
2.  **The Structural Break:** Census analysis confirms that coastal cities were losing population *before* 2020, yet prices rose. This supports the 'Golden Handcuffs' hypothesis: that job location supported prices until remote work broke the link.
...
* **Econometrics:** Utilized a Comparative Event Study framework with time-series normalization ($t=0$ at March 2020).
